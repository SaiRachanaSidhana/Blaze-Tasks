    ...
    fun clickDatePicker(){
        ...
        DatePickerDialog(this,
            { view, selectedYear, selectedMonth, selectedDayOfMonth ->
                ...
                Toast.makeText(this,
                    "Year was selected $year,month was selected ${month+1},day was selected $selectedDayOfMonth",Toast.LENGTH_LONG).show()
        ...
        val dpg= DatePickerDialog(this, DatePickerDialog.OnDateSetListener { view, year, month, sday ->
            ...
            TimePickerDialog(
                ...
                TimePickerDialog.OnTimeSetListener{ view, hour, min->
                    ...
                    Toast.makeText(this,
                        "Year was selected $year,month was selected ${month+1},day was selected $sday,hour is $hour,minutes is $min",Toast.LENGTH_LONG).show()
